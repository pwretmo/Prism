...
namespace Prism.Windsor.Wpf.Tests
{
    ...
    public class WindsorBootstrapperFixture : BootstrapperFixtureBase
    {
        ...
        public void RegisterFrameworkExceptionTypesShouldRegisterActivationException()
        {
            ...
            Assert.IsTrue(ExceptionExtensions.IsFrameworkExceptionRegistered(typeof(ComponentResolutionException)));
            Assert.IsTrue(ExceptionExtensions.IsFrameworkExceptionRegistered(typeof(ComponentNotFoundException)));
            Assert.IsTrue(ExceptionExtensions.IsFrameworkExceptionRegistered(typeof(ComponentRegistrationException)));
            Assert.IsTrue(ExceptionExtensions.IsFrameworkExceptionRegistered(typeof(CircularDependencyException)));
        }
